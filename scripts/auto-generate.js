...
const SITE_NAME = '美容デバイスJP';
const TOPIC = '美容家電・美顔器・ヘアケア家電';
const CRITERIA = '効果・使いやすさ・コスパ・耐久性・機能';
const A8_PRODUCT_NAME = 'オルビス ザ クレンジングオイル';
const A8_PRODUCT_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+CRMNSI+1USQ+4YM976';
const A8_PRODUCT_DESC = '美容師も愛用する人気クレンジング';
